...
/**
 * /proc/net/dev'i okuyup loopback (lo) hariç tüm ağ arayüzlerinin
 * toplam alınan (rx) ve gönderilen (tx) bayt sayısını döner.
 * Format: "iface: rxBytes rxPackets ... | txBytes txPackets ..."
 * (rx 8 alan, tx de 8 alan; ilk sütun her ikisinde de bayt sayısıdır)
 */
